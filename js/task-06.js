 ...
 * более медленный способ создания массива по сравнению с использованием 
 * литерала. Если нужен пустой массив, то рекомендуется использовать 
 * литерал массива.
 * 
...
function mapArray(array) {
  ...
  for (let i = 0; i < array.length; i += 1) {
    ...
    let totalNumbers = array[i] * 10;
    let numbersArrey = numbers;

    numbersArrey.splice(0, 0, totalNumbers);
  }

  let totalArray = numbers;
  totalArray.splice(array.length);
  totalArray.reverse();
...
console.log("return-1", mapArray([-2, 0, 2]));
// [-20, 0, 20]

console.log("return-2", mapArray([-2.5, 0, 2.5]));
// [-25, 0, 25]
